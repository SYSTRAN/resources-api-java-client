...
import net.systran.platform.resources.client.model.MultipartResponse;
import net.systran.platform.resources.client.auth.Authentication;
import net.systran.platform.resources.client.auth.HttpBasicAuth;
import net.systran.platform.resources.client.auth.ApiKeyAuth;
import net.systran.platform.resources.client.auth.OAuth;
